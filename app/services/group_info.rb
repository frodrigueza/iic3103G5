class GroupInfo
  ...
  def self.cuenta_banco_fabrica
  	return "556489daefb3d7030091baa8"
  end

  def self.almacen_recepcion
  	return "556489e7efb3d7030091bdcc"
  end

  def self.almacen_despacho
  	return "556489e7efb3d7030091bdcd"
  end

    def self.almacen_pulmon
  	return "556489e7efb3d7030091bf2a"
  end

  def self.almacen_libre
  	return "556489e7efb3d7030091bdce"
  end

  def self.almacen_devoluciones
  	return "556489e7efb3d7030091bf29"
  end
